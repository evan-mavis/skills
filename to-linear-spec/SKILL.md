...
3. Follow the user's Tech spec choice. For included Tech specs, use [the exact Tech spec template and example](references/tech-spec-template.md). Inspect the actual repo before naming paths, entities, or interfaces. Never present a guess as an agreed contract.
